...
const TAG_FAMILY_MAP = {
  "All": [],
  "Cold & Flu": ["Cold & Flu", "Cold", "Flu", "Cough", "Respiratory", "Throat"],
  "Digestion": ["Digestion", "Gut", "Acidity", "Nausea", "Bloating", "Constipation"],
  "Headache & Pain": ["Headache & Pain", "Headache", "Joint", "Muscle", "Period"],
  "Fever": ["Fever", "Mild Fever", "Viral Fever"],
  "Skin & Hair": ["Skin & Hair", "Skin", "Hair", "Acne", "Burns", "Eczema", "Dandruff"],
  "Sleep & Energy": ["Sleep & Energy", "Sleep", "Insomnia", "Fatigue", "Energy"],
  "Stress & Mood": ["Stress & Mood", "Stress", "Anxiety", "Burnout", "Mood"],
  "Immunity": ["Immunity", "Prevention", "Boosters"],
  "Allergy": ["Allergy", "Seasonal", "Dust", "Food"],
  "Women's Health": ["Women's Health", "PCOS", "Periods", "Pregnancy", "Hormonal"],
  "Children's Health": ["Children's Health", "Kids", "Infants", "Colic", "Teething"],
  "Blood Sugar": ["Blood Sugar", "Type 2", "Diabetes"],
  "Heart & BP": ["Heart & BP", "Circulation", "Blood Pressure"],
  "Oral Health": ["Oral Health", "Teeth", "Gums", "Breath", "Ulcers"],
  "Eye & Ear": ["Eye & Ear", "Strain", "Infection", "Wax", "Dry Eyes"],
  "Body Pain": ["Body Pain", "Joints", "Muscles", "Back", "Arthritis"],
  "Detox & Cleanse": ["Detox & Cleanse", "Liver", "Kidney", "Gut"],
  "Sports & Recovery": ["Sports & Recovery", "DOMS", "Sprains", "Cramps", "Recovery"],
};
