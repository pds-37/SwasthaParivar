...
app.use("/api/households", auth, apiRateLimiter.middleware(), householdRoutes);
app.use("/api/referral", auth, apiRateLimiter.middleware(), referralRoutes);
app.use("/api/account", auth, apiRateLimiter.middleware(), accountRoutes);
app.use("/api/config", auth, apiRateLimiter.middleware(), configRoutes);
